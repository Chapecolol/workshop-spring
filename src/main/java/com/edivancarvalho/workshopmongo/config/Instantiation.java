...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2024"), "Partiu Viagem", "Vou viajar para o Rio de Janeiro", maria);
		Post post2 = new Post(null, sdf.parse("18/05/2024"), "Bom dia!", "Desejo a todos um bom dia", maria);
